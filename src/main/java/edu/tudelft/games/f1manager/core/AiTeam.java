...
public class AiTeam extends Team {
   ...
   * @param car        list of cars owned by the team
   ...
   */
  public AiTeam(List<Driver> driverList, Car car, Strategist strategist,
                Aerodynamicist aerodynamicist, Mechanic mechanic, int points, int id) {
    super(driverList, car, strategist, aerodynamicist, mechanic, points, id);
  }
